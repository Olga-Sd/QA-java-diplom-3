...
//        driver = testBrowser.getDriver();
    ...
    public void testBunSectionSwitch() {
        ...
        MainPageObjects mainPage = new MainPageObjects(driver);
        mainPage.waitForMainPageLoad();
        mainPage.isBunSectionHeaderVisible();
        mainPage.souseSectionSwitcherClick();
        mainPage.isSouseSectionHeaderVisible();
        mainPage.bunsSectionSwitcherClick();

        // Если заголовок раздела "Булки" виден, то переход произошел успешно
        assertEquals(mainPage.isBunSectionHeaderVisible(), true);
    }
    @Test
    ...
    public void testSouseSectionSwitch() {
        ...
        // Если заголовок раздела "Соусы" виден, то переход произошел успешно
        assertEquals(mainPage.isSouseSectionHeaderVisible(), true);
    }
    ...
    public void testFillingsSectionSwitch() {
        ...
        // Если заголовок раздела "Соусы" виден, то переход произошел успешно
        assertEquals(mainPage.isFillingSectionHeaderVisible(), true);
    }
    @After
